...
function PendingJobs() {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md max-w-10xl mx-auto">
      <h2 className="text-2xl font-bold mb-6 text-dark-green">Pending Jobs (No Applications)</h2>
      ...
      {loading ? (
        ...
        <p className="text-gray-500 text-center">No pending jobs at the moment.</p>
      ) : (
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
